...
// clientLeafFor deliberately lives in tests: production CA.LeafFor issues
// server-auth leaves for the client-facing MITM only.
func clientLeafFor(t *testing.T, ca *CA, cn string) tls.Certificate {
	t.Helper()
